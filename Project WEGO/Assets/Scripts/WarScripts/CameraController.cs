...
public class CameraController : MonoBehaviour {
	...
	private void Start()
	{
        ...
        transform.position = new Vector3(Constants.RightOffset, transform.position.y, Constants.RightOffset);
	...
	private void LateUpdate()
	{
        if (CameraHasMoved == true)
        {
			...
			transform.position = new Vector3(Mathf.Clamp(transform.position.x, 0 + Constants.LeftOffset, mapWidth - Constants.RightOffset),
